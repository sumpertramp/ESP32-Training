/*
File: ESP32_Write_Data_LittleFS.ino
Date: [20.03.2024]

Description:
This code demonstrates basic file operations using the LittleFS library on ESP32.
It creates, writes, reads, appends to, renames, and deletes files, as well as
creates and removes directories. The code also includes a file I/O test to
measure performance.
